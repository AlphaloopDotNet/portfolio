    ...
    >
      <div className="swiper-container parallax-slider">
        ...
        <div className="social-icon">
          <a href="https://www.facebook.com/people/Alphaloop-it/100094405376504/?mibextid=ZbWKwL">
            <i className="fab fa-facebook-f"></i>
          </a>
          <a  href="https://x.com/AlphaloopIT">
            <i className="fab fa-twitter"></i>
          </a>
          <a href="https://www.linkedin.com/company/alphaloop-it/">
            <i className="fab fa-linkedin"></i>
          </a>
          <a href="https://www.instagram.com/alphaloopit/">
